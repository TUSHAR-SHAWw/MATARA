"""
Django settings for MaTARA project.
...
SECRET_KEY = 'django-insecure-ub=ro4^6vd!8$cft_1g387%+b)3tr)m(3x1j49%o)w@*(3rgc#'
...
WSGI_APPLICATION = 'MaTARA.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'MAIN.backends.CustomAuthBackend',  # Custom backend
